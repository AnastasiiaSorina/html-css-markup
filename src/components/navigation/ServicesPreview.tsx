...
const ServicePreviewDescription = "You can discover all our services by clicking the link below.";
  ...
  return (
    <Fragment>
      <Row className="services-preview">
        <Column size={4}>
          <SectionDescription buttonOff={"button-none"} sectionHeader={ServicePreviewHeader} sectionTittle={ServicePreviewTittle} sectionDescription={ServicePreviewDescription} />
        </Column>
